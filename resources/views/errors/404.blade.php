...
<html lang="en">
  <head>
    ...
    <!-- Core CSS -->
	<link href="{{ asset('assets/stylesheets/404.css') }}" rel="stylesheet">
  </head>
	<body class="blue-bg">
		  ...
		  <div class="col-md-12">
			<div class="message">
			<h2>Yönlendirme sırasında bir hata oluştu!</h2>
			<p>Ulaşmaya çalıştığınız sayfa bulunmamaktadır</p><br>
			<div class="btndiv"><div class="btnpop"><a href="{{ url('/') }}">{{ settings('site_title') }}</a></div></div>
			</div>
		  </div>
