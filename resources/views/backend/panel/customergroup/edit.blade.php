...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            <section class="panel">
                {!! Form::model($customergroup, ['class' => 'form-horizontal form-bordered', 'route' => ['admin.customergroup.update', $customergroup->id], 'method' => 'PATCH', 'id' => 'my-form']) !!}
                ...
                <header class="panel-heading">
                    <div class="panel-actions">
                        ...
                        @if(Entrust::can('list-customergroups'))
                            <a href="{{ route('admin.customergroup.index') }}" data-toggle="tooltip"
                    ...
                    @if($customergroup->title)
                    <p class="panel-subtitle">
                        {{ $customergroup->title }} <i class="fa fa-level-up"></i>
                    </p>
                    @endif
                </header>
...
@section('js')
    ...
    <script>
        $('select[name="locale"]').bind('change', function (e) {
            var a = "{{ route('admin.customergroup.edit', $customergroup->id) }}";
            var b = $(this).val();
