                    ...
                    <div class="nano-content">
                        ...
                        <div class="inner-menu-content">
                            ...
                            <a class="btn btn-block btn-primary btn-md pt-sm pb-sm text-md"
                               href="{{ url('admin/'.$module.'/'.$id.'/pictures/upload') }}">
                                    ...
                                    <div class="mg-thumb-options">
                                        ...
                                        <div class="mg-toolbar">
                                            ...
                                            <div class="mg-group pull-right">
                                                <a href="{{ url('admin/'.$module.'/'.$id.'/pictures/edit-image/'.$picture->id) }}">Düzenle</a>
                                                ...
                                                <ul role="menu" class="dropdown-menu mg-menu">
                                                    ...
                                                    <li>
                                                        <a href="#modalIcon" class="delete-item modal-basic" data-href="{{ url('admin/'.$module.'/'.$id.'/pictures/delete/'.$picture->id) }}">
...
@section('js')
    ...
    <script>
        function multiDelete() {
            ...
            if (images.length > 0) {
                $.ajax({
                    url: "{{ url('admin/'.$module.'/'.$id.'/pictures/multi-delete') }}",
                    method: "POST",
