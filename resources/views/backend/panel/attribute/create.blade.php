...
@section('title', 'Yeni Öznitelik - Kontrol Paneli')
@section('subtitle', 'Yeni')
@section('breadcrumb', '
    <li><span>Özniteliklar</span></li>
...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12">
            <section class="panel">
                {!! Form::open(['class' => 'form-horizontal form-bordered', 'route' => 'admin.attribute.store', 'files' => true, 'id' => 'my-form']) !!}
                ...
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Öznitelik Ekle</u></h2>
                </header>
